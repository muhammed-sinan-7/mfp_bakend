...
def pydantic_wrapper(
    ...
    BaseModel: typing.Type["BaseModel"] = (
        pydantic.BaseModel
    )  # noqa: F811  # only defined when type checking
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._custom_task_cls_used = (
            ...
            or self.__class__ is not Celery
            and hasattr(self.__class__, "task_cls")
        )
