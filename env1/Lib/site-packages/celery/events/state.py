...
class Task:
    ...
    name = received = sent = started = succeeded = failed = retried = revoked = (
        rejected
    ) = args = kwargs = eta = expires = retries = worker = result = exception = (
        timestamp
    ) = runtime = traceback = exchange = routing_key = root_id = parent_id = client = (
        None
    )
