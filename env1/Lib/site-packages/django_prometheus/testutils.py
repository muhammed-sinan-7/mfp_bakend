...
def assert_metric_diff(
    frozen_registry, expected_diff, metric_name, registry=REGISTRY, **labels
):
    ...
    case.
    """
    saved_value = get_metric_from_frozen_registry(
...
def assert_metric_compare(
    frozen_registry, predicate, metric_name, registry=REGISTRY, **labels
):
