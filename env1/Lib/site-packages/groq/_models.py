        ...
        **values: object,
        ...
        for key, value in values.items():
            if key not in model_fields:
                parsed = (
                    construct_type(value=value, type_=extra_field_type)
    ...
    if PYDANTIC_V1:
        ...
        def model_dump(
            ...
            *,
            ...
            return (
                cast("dict[str, Any]", json_safe(dumped)) if mode == "json" else dumped
            )
...
def _construct_field(value: object, field: FieldInfo, key: str) -> object:
    ...
    return construct_type(
        value=value, type_=type_, metadata=getattr(field, "metadata", None)
    )
...
def construct_type(
    *, value: object, type_: object, metadata: Optional[List[Any]] = None
) -> object:
    """Loose coercion to the expected type with construction of nested values.
...
DISCRIMINATOR_CACHE: weakref.WeakKeyDictionary[type, DiscriminatorDetails] = (
    ...
    for variant in get_args(union):
        ...
        if is_basemodel_type(variant):
            if PYDANTIC_V1:
                ...
                ) and is_literal_type(annotation):
...
class FinalRequestOptionsInput(TypedDict, total=False):
    ...
    idempotency_key: str
    content: Union[
        bytes, bytearray, IO[bytes], Iterable[bytes], AsyncIterable[bytes], None
    ]
    json_data: Body
