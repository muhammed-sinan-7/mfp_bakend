...
class Completions(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        compound_custom: (
            Optional[completion_create_params.CompoundCustom] | Omit
        ) = omit,
        ...
        reasoning_effort: (
            Optional[Literal["none", "default", "low", "medium", "high"]] | Omit
        ) = omit,
        reasoning_format: Optional[Literal["hidden", "raw", "parsed"]] | Omit = omit,
        response_format: (
            Optional[completion_create_params.ResponseFormat] | Omit
        ) = omit,
        search_settings: (
            Optional[completion_create_params.SearchSettings] | Omit
        ) = omit,
        seed: Optional[int] | Omit = omit,
        service_tier: (
            Optional[Literal["auto", "on_demand", "flex", "performance"]] | Omit
        ) = omit,
