...
class Message:
    ...
    def parse_headers(self, data, from_trailer=False):
        ...
        if from_trailer:
            ...
            pass
        elif not isinstance(self.peer_addr, tuple) or _ip_in_allow_list(
            self.peer_addr[0], cfg.forwarded_allow_ips, cfg.forwarded_allow_networks()
        ):
...
class Request(Message):
    ...
    def proxy_protocol_access_check(self):
        ...
        if isinstance(self.peer_addr, tuple) and not _ip_in_allow_list(
            self.peer_addr[0], self.cfg.proxy_allow_ips, self.cfg.proxy_allow_networks()
        ):
