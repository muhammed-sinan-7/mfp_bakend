...
class PythonProtocol:
    ...
    def _parse_headers(self):
        ...
        while True:
            ...
            if (
                self._limit_request_field_size > 0
                and len(line) > self._limit_request_field_size
            ):
            ...
            if (
                self._limit_request_fields > 0
                and self._header_count > self._limit_request_fields
            ):
