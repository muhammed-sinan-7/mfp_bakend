...
class Channel(virtual.Channel):
    ...
    def wait_time_seconds(self):
        return self.options.get("wait_time_seconds", self.default_wait_time_seconds)
    ...
    def common_config(self):
        ...
        config = {
            "bootstrap.servers": f"{conninfo.hostname}:{int(conninfo.port) or DEFAULT_PORT}",
        }
...
class Transport(virtual.Transport):
    ...
    recoverable_connection_errors = (NoBrokersAvailable,)
