...
class Channel(virtual.Channel):
    ...
    def _receive_message(
        ...
        message_system_attribute_names = (
            self.get_message_attributes.get("MessageSystemAttributeNames") or []
        )

        message_attribute_names = (
            self.get_message_attributes.get("MessageAttributeNames") or []
        )
    ...
    def get_message_attributes(self) -> dict[str, Any]:
        ...
        if isinstance(fetch, list):
            ...
            if isinstance(attrs, list) and attrs:
                message_attrs = (
                    ["ALL"]
                    if "ALL".lower() in [s.lower() for s in attrs]
                    else (list(set(attrs)))
                )
