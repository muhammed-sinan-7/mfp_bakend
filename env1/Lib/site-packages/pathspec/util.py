...
from typing import Callable  # Replaced by `collections.abc.Callable` in 3.9.2.
from typing import Optional  # Replaced by `X | None` in 3.10.
from typing import Union  # Replaced by `X | Y` in 3.10.
from typing import Any, Generic, TypeVar

from ._typing import AnyStr  # Removed in 3.18.
from ._typing import deprecated  # Added in 3.13.
